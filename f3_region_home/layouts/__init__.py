...
from .default_layout import default_layout
                ...
                rx.box(
                    rx.box(
                        ...
                        *children,
                        rx.link(
                            rx.callout(
                                "Disclaimer: This project is not affiliated with or endorsed by MapLibre GL. It is an independent, open-source integration into the Reflex framework. For the official version, please visit the MapLibre website.",  # noqa: E501
                                icon="info",
                                variant="outline",
                            ),
